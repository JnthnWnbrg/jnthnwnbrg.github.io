var lsb=false; //if want Least Significant Bit first
...
function scheduleNote( beatNumber, time ) {
    ...
    var bits=string.charCodeAt(beatNumber/utf_length);
    if (lsb) {
	bit = 1 & (bits >> (beatNumber%utf_length));
	//LSB first
	//rightshift bits >>
...
TML+="lsb";
	...
	bit = 1 & (bits >> ((utf_length-1)-(beatNumber%utf_length)));
	//GSB first
	//1 is 0000 0001
	//example beatNumber is 67, utf is 8
